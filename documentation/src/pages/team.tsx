...
export default function TeamPage(): JSX.Element {
  ...
  const authors = siteConfig.themeConfig?.authors || {};

  const authorList = Object.entries(authors).map(([key, author]) => ({
    key,
    ...author,
  }));

  return (
    <Layout title="Team" description="WarpTorch Team">
      <main className={styles.teamContainer}>
        <div className="container">
          <div className={styles.header}>
            <h1>Meet the Team</h1>
            <p>The people behind WarpTorch</p>
          </div>
